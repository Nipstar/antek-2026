export function Head() {
  return (
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Andover', item: 'https://www.antekautomation.com/locations/andover' },
            ],
          }),
        }}
      />
      ...
      {/* Service Schema — WHO (Antek/Andy) → WHAT (voice agents, chatbots, automation) → WHERE (Andover, Hampshire) */}
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            caption: 'Antek Automation — AI automation for Andover businesses',
            contentLocation: {
              '@type': 'City',
              name: 'Andover',
              sameAs: ['https://en.wikipedia.org/wiki/Andover,_Hampshire', 'https://www.wikidata.org/wiki/Q492805'],
